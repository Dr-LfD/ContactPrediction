from contact_pred.scripts.model.common.normalizer import SingleFieldLinearNormalizer
from contact_pred.scripts.common.pytorch_util import dict_apply, dict_apply_reduce, dict_apply_split
import numpy as np
