...
from contact_pred.scripts.model.vision.crop_randomizer import CropRandomizer
from contact_pred.scripts.model.common.module_attr_mixin import ModuleAttrMixin
from contact_pred.scripts.common.pytorch_util import dict_apply, replace_submodules
...
class DictImageObsEncoder(ModuleAttrMixin):
    def __init__(self,
        ...
        for key, attr in obs_shape_meta.items():
            ...
            if type == 'rgb':
                ...
                pass  # consumed directly by the predictor; encoder ignores these keys
            else:
    ...
    def output_shape(self):
        ...
        batch_size = 1
        for key, attr in obs_shape_meta.items():
            if attr.get('type') == 'proprio':
                continue  # proprio keys are not processed by the encoder
            shape = tuple(attr['shape'])
